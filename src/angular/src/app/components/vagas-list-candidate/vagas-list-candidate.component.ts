...
@Component({
  selector: 'app-vagas-list-candidate',
  templateUrl: './vagas-list-candidate.component.html',
  styleUrls: ['./vagas-list-candidate.component.scss']
})
export class VagasListCandidateComponent implements OnInit {
